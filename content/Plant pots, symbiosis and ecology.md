Isn't it super annoying that for each plant pot that you have, you need to make sure it gets _just_ the right amount of water; you need to periodically feed it with fertilizer. If you forget to water it once depending on the plant it might wilt and struggle.
When pests manage to find their way inside and make themselves at home in your beautiful monstera, it can take days or weeks of effort to get rid of them.

The common factor here is _effort_. For every need an indoor plant has, you are the only one who can take care of it. This means that the plant is entirely dependent on you.

This article is doing two things simultaneously, I want to take a closer look at the symbiotic relationships of indoor plants, and I want to further explore the idea of creating [[Symbiosis as metaphor|a notation for symbiosis]]. Note that the notation is still a work-in-progress, it is not yet set-in-stone.
...
$\text{You}\,+\longleftrightarrow+\, \text{Indoor potted plant}$`
...
I'm not entirely sure yet how I want to denote this kind of a relationship in the notation, but for now it might be sufficient to just use an extra plus. _The potted plant **gains more** from this relationship than the human does_.

$$\text{You}\,+\longleftrightarrow++\, \text{Indoor potted plant}$$

I'm not completely happy about this notation, because it doesn't really communicate effectively the idea that the plant is _entirely dependent_ on you. It just looks like the plant benefits more than you do, but there's more going on than just that.
...
$$\text{You}\,+\longleftrightarrow+\, \text{Pet dog}$$
## The insects strike
...
![[Pasted image 20250915000419.png]]
> Mealybugs feeding on a hibiscus plant
> [source](https://commons.wikimedia.org/wiki/File:Mealybugs_feeding_on_hibiscus_plant.jpg)
...
$$\text{Lemon tree}\,-\longleftrightarrow+\,\text{Mealybugs}$$

Nothing strange here. What happens if we take both of these relationships and look at them at the same time?

$$\text{Me}\,+\longleftrightarrow+\, [\text{Indoor potted plant}\,-\longleftarrow+\,\text{Mealybugs}]$$

> [!NOTE] Square brackets indicate a closed ecosystem
...
> 
> The best example of a closed ecosystem is the ecosystem in a jar.$$[\text{Ecosystem in a jar}]$$ A bee and a flowering plant in a field are in part of a much greater ecosystem, and are therefore not surrounded by square brackets: $$\text{bee}\,+\longleftrightarrow+\,\text{flowering plant}$$
> 
> Note that in the relationship above, "you" are not enclosed within this closed ecosystem even though you _do_ play a role within it. You participate within a much greater ecosystem.
...
$$\text{Me}\,-\longleftarrow+[...\,\text{Mealybugs}]$$
...
There is one particular relationship that is also an important part of symbiosis, which I've also touched upon in my earlier article. Sometimes what's _not there_ is more important than what _is_ there.
...
![[Pasted image 20250915012834.png]]
> A shelf with rows of plant pots
> [source](https://www.thegardener.co.za/the-gardener/diy/shelf-life/)
...
There is so much these potted plants are missing out on, [companion planting](https://en.wikipedia.org/wiki/Companion_planting), [and a huge variety of soil biodiversity interactions](https://soil.evs.buffalo.edu/index.php/Biodiversity_interactions). All this is something that _we_ as the caretaker now have to do, and if we don't? We miss out on what the plant could have been, or we bear the cost in some other way.
## This is not what a healthy ecosystem looks like!

All of this just to make extremely explicit that _this is not a healthy ecosystem_. Go outside, go take a look at some plants in a more biodiverse ecosystem. You're bound to found some insect infestations on the plants there, but you'll be hard pressed to find a single spot that is completely overrun by a singular species of parasitic insect.

That's because insect infestations are kept in check by the rest of the ecosystem. Ladybugs for example, they _eat_ mealybugs!

![[Pasted image 20250915005603.png]]
> Cryptolaemus montrouzieri, a species of ladybug which is also known as the _mealybug destroyer_.
> [source](https://nl.wikipedia.org/wiki/Cryptolaemus_montrouzieri)

In turn, some birds eat ladybugs. This is the well-known [food chain](https://en.wikipedia.org/wiki/Food_chain) in action.

$$\text{Plants}\,-\leftarrow+\,\text{Mealybugs}\,-\leftarrow+\,\text{Ladybugs}\,-\leftarrow+\,\text{Birds}$$

Note that there are no square brackets, there are many more interactions within this complex ecosystem. Too many to write down in fact! The more important point is that the ecosystem keeps populations in-check through [ecosystem population dynamics](https://en.wikipedia.org/wiki/Population_ecology)

## Could we do this differently?

I personally feel like the idea of plant pots is antiquated and outdated. We know much too much about plant biology, ecology, symbiosis and resilience to keep going like this. There is a lot of room for innovation here.
There are of course completely alternative ways of growing plants inside that deviate from the standard "plant in a pot" method.

But it's not like the plant pots are here for good reasons we just don't know about á la [chesterton's fence](https://en.wiktionary.org/wiki/Chesterton%27s_fence), [plant pots were initially invented to help with transportation](https://hc-companies.com/plant-containers/), not because they're the best way to keep plants around!

There are of course already some different ways of keeping plants inside. [Hydroponics](https://en.wikipedia.org/wiki/Hydroponics) is one example, and the simple idea of growing multiple (different) plants in a single container is another.
